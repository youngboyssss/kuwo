...
class Xiangqing extends React.Component{
        ...
        return (
            <div>
				...
				<div className="heder-1">
					...
					<span className="context-1">吐小曹扒新闻</span>
	...
	jiazai(){
		axios.get("http://nplserver.kuwo.cn/pl.svc?op=getlistinfo&pid=1013437785&pn=0&rn=30&vipver=1&encode=utf-8&keyset=pl2012&identity=kuwo")
